...
#ifndef COM_RODENSTOCK_CNXT_CONNECTOR_CLIENT_API_ApiClient_H_
#define COM_RODENSTOCK_CNXT_CONNECTOR_CLIENT_API_ApiClient_H_
...
#endif /* COM_RODENSTOCK_CNXT_CONNECTOR_CLIENT_API_ApiClient_H_ */
