...
void SessionResponse::validate()
{
    // TODO: implement validation
}

web::json::value SessionResponse::toJson() const
{
...
void SessionResponse::fromJson(const web::json::value& val)
{
...
void SessionResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SessionResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
...
utility::string_t SessionResponse::getId() const
{
    return m_Id;
}

void SessionResponse::setId(const utility::string_t& value)
{
    m_Id = value;
    
}

utility::string_t SessionResponse::getExternalId() const
{
    return m_ExternalId;
}

void SessionResponse::setExternalId(const utility::string_t& value)
{
    m_ExternalId = value;
    m_ExternalIdIsSet = true;
}

bool SessionResponse::externalIdIsSet() const
{
    return m_ExternalIdIsSet;
}

void SessionResponse::unsetExternalId()
{
    m_ExternalIdIsSet = false;
}

utility::string_t SessionResponse::getName() const
{
    return m_Name;
}

void SessionResponse::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool SessionResponse::nameIsSet() const
{
    return m_NameIsSet;
}

void SessionResponse::unsetName()
{
    m_NameIsSet = false;
}

utility::string_t SessionResponse::getNotes() const
{
    return m_Notes;
}

void SessionResponse::setNotes(const utility::string_t& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}

bool SessionResponse::notesIsSet() const
{
    return m_NotesIsSet;
}

void SessionResponse::unsetNotes()
{
    m_NotesIsSet = false;
}

utility::string_t SessionResponse::getState() const
{
    return m_State;
}

void SessionResponse::setState(const utility::string_t& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool SessionResponse::stateIsSet() const
{
    return m_StateIsSet;
}

void SessionResponse::unsetState()
{
    m_StateIsSet = false;
}

utility::string_t SessionResponse::getPatientId() const
{
    return m_PatientId;
}

void SessionResponse::setPatientId(const utility::string_t& value)
{
    m_PatientId = value;
    m_PatientIdIsSet = true;
}

bool SessionResponse::patientIdIsSet() const
{
    return m_PatientIdIsSet;
}

void SessionResponse::unsetPatientId()
{
    m_PatientIdIsSet = false;
}

std::shared_ptr<Patient> SessionResponse::getPatient() const
{
    return m_Patient;
}

void SessionResponse::setPatient(const std::shared_ptr<Patient>& value)
{
    m_Patient = value;
    m_PatientIsSet = true;
}

bool SessionResponse::patientIsSet() const
{
    return m_PatientIsSet;
}

void SessionResponse::unsetPatient()
{
    m_PatientIsSet = false;
}

std::shared_ptr<B2BOptic> SessionResponse::getB2bOptic() const
{
    return m_B2bOptic;
}

void SessionResponse::setB2bOptic(const std::shared_ptr<B2BOptic>& value)
{
    m_B2bOptic = value;
    m_B2bOpticIsSet = true;
}

bool SessionResponse::b2bOpticIsSet() const
{
    return m_B2bOpticIsSet;
}

void SessionResponse::unsetB2bOptic()
{
    m_B2bOpticIsSet = false;
}

utility::datetime SessionResponse::getCreatedAt() const
{
    return m_CreatedAt;
}

void SessionResponse::setCreatedAt(const utility::datetime& value)
{
    m_CreatedAt = value;
    m_CreatedAtIsSet = true;
}

bool SessionResponse::createdAtIsSet() const
{
    return m_CreatedAtIsSet;
}

void SessionResponse::unsetCreatedAt()
{
    m_CreatedAtIsSet = false;
}

utility::datetime SessionResponse::getUpdatedAt() const
{
    return m_UpdatedAt;
}

void SessionResponse::setUpdatedAt(const utility::datetime& value)
{
    m_UpdatedAt = value;
    m_UpdatedAtIsSet = true;
}

bool SessionResponse::updatedAtIsSet() const
{
    return m_UpdatedAtIsSet;
}

void SessionResponse::unsetUpdatedAt()
{
    m_UpdatedAtIsSet = false;
}

std::shared_ptr<SessionLink> SessionResponse::getLinks() const
{
    return m__links;
}

void SessionResponse::setLinks(const std::shared_ptr<SessionLink>& value)
{
    m__links = value;
    m__linksIsSet = true;
}

bool SessionResponse::linksIsSet() const
{
    return m__linksIsSet;
}

void SessionResponse::unset_links()
{
    m__linksIsSet = false;
}
